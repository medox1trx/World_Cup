...
import { getHospitalities, getImageUrl } from "../services/api";
        ...
        <div className="hw">
          ...
          {loading ? (
            <div style={{ padding: 100, textAlign: "center", color: tSub }}>
              Chargement de l'Hospitalité...
            </div>
          ) : (
            <div className="fz-grid">
              {hospitalities.map((h) => (
                <div key={h.id} className="fz-card">
                  <div className="fz-img-wrap">
                    <img
                      ...
                      className="fz-img"
                      onError={e => {
                        e.currentTarget.src = `https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=800`;
                      }}
                    />
                  </div>
                  <h3 className="fz-name">{h.tier}</h3>
                </div>
              ))}
            </div>
          )}
