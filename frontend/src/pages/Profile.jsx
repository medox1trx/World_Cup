  ...
  return (
    <div style={{ 
      ...
      <style>{`
        ...
        .nav-link.active { background: var(--text-main); color: var(--main-bg); }
        .nav-link:not(.active):hover { background: ${darkMode ? "#222" : "#f0f0f0"}; }
        .logout-btn { color: var(--main-bg); background: var(--text-main); border: none; padding: 10px 20px; border-radius: 8px; font-weight: 800; cursor: pointer; margin-top: 20px; }
        ...
        .booking-card { display: flex; align-items: center; gap: 24px; padding: 24px 0; border-bottom: 1px solid ${darkMode ? "#222" : "#eee"}; }
        ...
        .ticket-header { background: var(--text-main); padding: 32px; color: var(--main-bg); position: relative; overflow: hidden; }
        ...
        @media print {
          ...
          .ticket-header { background: #000 !important; color: white !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      ...
      <div className="dashboard-container">
        ...
        <div className="sidebar">
          <div style={{ padding: "0 16px 32px" }}>
            <div style={{ width: 48, height: 48, borderRadius: "50%", background: darkMode ? "#fff" : "#000", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 18, color: darkMode ? "#000" : "#fff", marginBottom: 12 }}>
              {user.name.charAt(0)}
            </div>
          ...
          <div className="nav-link" onClick={() => setActiveTab("tickets")} style={{ background: activeTab === "tickets" ? (darkMode ? "#fff" : "#000") : "transparent", color: activeTab === "tickets" ? (darkMode ? "#000" : "#fff") : "inherit" }}>
            <Ticket size={18} /> Mes Billets
          </div>
          <div className="nav-link" onClick={() => setActiveTab("profile")} style={{ background: activeTab === "profile" ? (darkMode ? "#fff" : "#000") : "transparent", color: activeTab === "profile" ? (darkMode ? "#000" : "#fff") : "inherit" }}>
        ...
        <div className="content-card">
          {activeTab === "bookings" ? (
            <div>
              <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 8 }}>Mes Séjours</h2>
              <p style={{ color: darkMode ? "#888" : "#666", marginBottom: 32 }}>Gérez vos hébergements pour la Coupe du Monde de la FIFA 2026™</p>
              ...
              {loading ? (
                ...
                <div style={{ textAlign: "center", padding: "60px 0" }}>
                  <AlertCircle size={48} style={{ opacity: 0.2, marginBottom: 16 }} />
                   <p style={{ color: darkMode ? "#888" : "#666" }}>Aucune réservation trouvée. Prêt pour votre prochain voyage ?</p>
                   <Link to="/cities" style={{ display: "inline-block", marginTop: 16, color: "var(--text-main)", fontWeight: 800, textDecoration: "underline" }}>Parcourir les Villes <ChevronRight size={14} style={{ verticalAlign: "middle" }} /></Link>
                </div>
              ) : (
                  ...
                  <div key={res.id} className="booking-card">
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom: 4 }}>
                         <span style={{ fontSize: 10, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--text-main)", display: "flex", alignItems: "center", gap: 4 }}>
                    ...
                    <div style={{ textAlign: "right" }}>
                        <span style={{ display: "block", fontSize: 18, fontWeight: 900, color: "var(--text-main)" }}>${res.total_price}</span>
                      <button 
                        onClick={() => handleCancel(res.id)}
                        style={{ background: "none", border: "none", color: "var(--text-main)", cursor: "pointer", fontSize: 12, padding: "8px 0", fontWeight: 700, display: "flex", alignItems: "center", gap: 4, marginLeft: "auto", textDecoration: "underline" }}>
            ...
            <div>
              <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 8 }}>Mes Billets</h2>
              <p style={{ color: darkMode ? "#888" : "#666", marginBottom: 32 }}>Vos billets de match officiels pour le tournoi 2026™</p>
              ...
              {loading ? (
                ...
                <div style={{ textAlign: "center", padding: "60px 0" }}>
                  <AlertCircle size={48} style={{ opacity: 0.2, marginBottom: 16 }} />
                   <p style={{ color: darkMode ? "#888" : "#666" }}>Aucun billet trouvé. Préparez-vous pour l'action !</p>
                   <Link to="/tickets" style={{ display: "inline-block", marginTop: 16, color: "var(--text-main)", fontWeight: 800, textDecoration: "underline" }}>Parcourir les Billets <ChevronRight size={14} style={{ verticalAlign: "middle" }} /></Link>
                </div>
              ) : (
                    ...
                    <div key={book.id} className="booking-card" style={{ overflow: "hidden" }}>
                      ...
                      <div style={{ 
                        ...
                        textAlign: "center"
                         ...
                         <span style={{ fontSize: 10, fontWeight: 900, textTransform: "uppercase", color: "var(--text-main)", letterSpacing: "0.05em" }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom: 8 }}>
                           <span style={{ 
                             ...
                             {book.status?.toLowerCase() === 'confirmed' && <CheckCircle size={12} />}
                             {book.status}
                           </span>
                        ...
                        <h4 style={{ 
                          ...
                          {book.ticket?.match?.team1?.name || "TBD"} <span style={{ color: "var(--text-main)", fontSize: 14 }}>VS</span> {book.ticket?.match?.team2?.name || "TBD"}
                        </h4>
                        
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "12px 20px", marginTop: 8, fontSize: 12, color: darkMode ? "#888" : "#666" }}>
                          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            <MapPin size={14} style={{ color: "var(--text-main)" }} /> 
                            <span style={{ fontWeight: 600 }}>{book.ticket?.match?.venue}</span>
                          </span>
                          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            <Ticket size={14} style={{ color: "var(--text-main)" }} /> 
                      ...
                      <div style={{ textAlign: "right", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-end" }}>
                        <span style={{ display: "block", fontSize: 20, fontWeight: 900, color: "var(--text-main)", fontFamily: FD }}>
            ...
            <div>
              <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 8 }}>Paramètres du profil</h2>
              <p style={{ color: darkMode ? "#888" : "#666", marginBottom: 32 }}>Mettez à jour vos informations personnelles</p>
              
              <div style={{ maxWidth: 500 }}>
                <ProfileField label="Nom complet" value={profileName} onChange={e => setProfileName(e.target.value)} />
                <ProfileField label="Adresse e-mail" value={profileEmail} onChange={e => setProfileEmail(e.target.value)} />
      ...
      <div className={`ticket-modal-overlay ${showTixModal ? 'open' : ''}`} onClick={() => setShowTixModal(false)}>
        <div className="digital-ticket" onClick={e => e.stopPropagation()}>
          <div className="ticket-header" style={{ background: "var(--text-main)", padding: "32px", color: "var(--main-bg)", position: "relative", overflow: "hidden" }}>
             <div style={{ position: "absolute", top: -20, right: -20, width: 120, height: 120, background: "rgba(128,128,128,0.1)", borderRadius: "50%" }} />
             <div style={{ position: "absolute", bottom: -30, left: -20, width: 80, height: 80, background: "rgba(128,128,128,0.1)", borderRadius: "50%" }} />
             
             <div style={{ borderLeft: "3px solid var(--main-bg)", paddingLeft: 12, position: "relative", zIndex: 2 }}>
                ...
                <h2 style={{ fontFamily: FD, fontSize: 28, fontWeight: 900, textTransform: "uppercase", margin: 0, lineHeight: 1 }}>Billet de Match Officiel</h2>
             </div>
          </div>
          ...
          <div className="ticket-body" style={{ padding: "32px", position: "relative", background: darkMode ? "#1a1a1a" : "#fff", borderBottom: `2px dashed ${darkMode ? "#333" : "#eee"}` }}>
            ...
            <div style={{ marginBottom: 28 }}>
              <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 6, letterSpacing: "0.05em" }}>Entrée de Match</p>
              <h4 style={{ margin: 0, fontSize: 22, fontWeight: 900, fontFamily: FD }}>
                {activeTix?.ticket?.match?.team1?.name || "TBD"} <span style={{ color: "var(--text-main)" }}>VS</span> {activeTix?.ticket?.match?.team2?.name || "TBD"}
              </h4>
              <div style={{ display: "inline-block", marginTop: 4, padding: "2px 8px", border: "1px solid var(--text-main)", color: "var(--text-main)", borderRadius: 4, fontSize: 10, fontWeight: 900, textTransform: "uppercase" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, marginBottom: 28 }}>
              <div>
                <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 4 }}>Date du Match</p>
              ...
              <div>
                <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 4 }}>Coup d'envoi</p>
                <p style={{ margin: 0, fontSize: 16, fontWeight: 800 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 4 }}>Stade</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
              <div>
                <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 4 }}>Catégorie</p>
                <p style={{ margin: 0, fontSize: 16, fontWeight: 800 }}>Catégorie {activeTix?.ticket?.category}</p>
              </div>
              <div>
                <p style={{ margin: 0, fontSize: 10, fontWeight: 800, textTransform: "uppercase", color: "#888", marginBottom: 4 }}>N° Référence</p>
                <p style={{ margin: 0, fontSize: 13, fontWeight: 900, color: "var(--text-main)", letterSpacing: "0.05em" }}>{activeTix?.booking_reference}</p>
              </div>
            </div>
          </div>
          ...
          <div className="ticket-footer" style={{ padding: "32px", background: darkMode ? "#111" : "#fcfcfc", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <p style={{ marginTop: "16px", fontSize: "11px", fontWeight: "900", textTransform: "uppercase", color: "#aaa", letterSpacing: "0.15em" }}>Scannez au tourniquet</p>
